...
set(CMAKE_C_COMPILER   "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-gcc${EXECUTABLE_SUFFIX}")
set(CMAKE_CXX_COMPILER "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-g++${EXECUTABLE_SUFFIX}")
set(CMAKE_AR           "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-ar${EXECUTABLE_SUFFIX}")
set(CMAKE_LINKER       "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-ld${EXECUTABLE_SUFFIX}")
set(CMAKE_OBJCOPY      "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-objcopy${EXECUTABLE_SUFFIX}")
set(CMAKE_OBJDUMP      "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-objdump${EXECUTABLE_SUFFIX}")
set(CMAKE_NM           "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-nm${EXECUTABLE_SUFFIX}")
set(CMAKE_RANLIB       "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-ranlib${EXECUTABLE_SUFFIX}")
set(CMAKE_STRIP        "${KAA_ARM_TOOLCHAIN}/bin/arm-none-eabi-strip${EXECUTABLE_SUFFIX}")
