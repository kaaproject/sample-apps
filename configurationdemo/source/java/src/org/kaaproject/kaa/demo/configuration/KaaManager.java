...
/**
 * Class that shows Kaa configuration API, works with endpoints and it's profiles
 *
 * @see <a href="http://docs.kaaproject.org/display/KAA/Endpoint+profiling">Configuration API</a>
 */
public class KaaManager {
    ...
    public void displayConfiguration(int index) {
        ...
        if (kaaClient != null) {
            ...
            LOG.info(index + "-th configuration body (have vibro-, audio-, video-support):");
