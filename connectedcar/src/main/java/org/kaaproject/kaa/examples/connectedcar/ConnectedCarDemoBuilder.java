...
@KaaDemoBuilder
public class ConnectedCarDemoBuilder extends AbstractDemoBuilder {

    private static final Logger logger = LoggerFactory.getLogger(ConnectedCarDemoBuilder.class);

    public ConnectedCarDemoBuilder() {
    ...
    protected void buildDemoApplicationImpl(AdminClient client) throws Exception {
        ...
        CTLSchemaDto ctlConfSchema = client.saveCTLSchemaWithAppToken(getResourceAsString("configurationSchema.json"), connectedCarApplication.getTenantId(), connectedCarApplication.getApplicationToken());
