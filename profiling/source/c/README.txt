...
This demo application illustrates profiling and grouping features feature using the Kaa C SDK.
To read more about the profiling feature visit http://docs.kaaproject.org/display/KAA/Endpoint+profiling.
To read more about the grouping feature visit http://docs.kaaproject.org/display/KAA/Endpoint+grouping.
