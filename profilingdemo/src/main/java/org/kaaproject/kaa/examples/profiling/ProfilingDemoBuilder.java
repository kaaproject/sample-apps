...
public class ProfilingDemoBuilder extends AbstractDemoBuilder {
    ...
    protected void buildDemoApplicationImpl(AdminClient client) throws Exception {
        ...
        // TODO: check does we can add a configuration to "All" group (at least one conf must be generated by default values of scheme automatically)
        ...
        createProfileGroupFilter(client, application, endpointGroup, serverProfileSchema,
    ...
    private EndpointGroupDto getBaseEndpointGroup(AdminClient client, ApplicationDto application) throws Exception {
        ...
        if (endpointGroups.size() == 1 && endpointGroups.get(AUTO_GENERATED_SCHEMA_VERSION).getWeight() == 0) {
            baseEndpointGroup = endpointGroups.get(AUTO_GENERATED_SCHEMA_VERSION);
        }
    ...
    private void createConfiguration(AdminClient client, ApplicationDto application, ConfigurationSchemaDto configurationSchema,
        ...
        baseConfiguration.setApplicationId(application.getId());
    ...
    private void createProfileGroupFilter(AdminClient client, ApplicationDto application, EndpointGroupDto endpointGroup,
        ...
        profileFilter.setStatus(filterStatus);
